...
<head>
    ...
    <link rel="stylesheet" href="../stylesheet/tweetresponseTail.css">
    <link rel="stylesheet" href="../stylesheet/tweetresponse.css">
    <link rel="stylesheet"
        ...
        <div class="grid md:grid-cols-1">
            ...
            <div class="sm:ml-30 padding-left p-0">
                <div class="p-4 grid padding-left p-0 padding-left">
                    <div class="sticky top-0 bg-white drop-shadow-2xl">
                        ...
                        <header>
                            <div class="flex content-center justify-around space-x-4 p-3 border-b-4-yellow-400">
                                <input onclick=""
                                    class="bg-white hover:bg-gray-100 text-gray-800 font-semibold items-center border border-gray-400 rounded shadow hover:bg-lime-200 p-3"
                                    type="button" value="For you">
                                <input onclick=""
                                    class="hover:bg-gray-100 text-gray-800 font-semibold  items-center border border-gray-400 rounded shadow hover:bg-lime-200 p-3"
                                    type="button" value="Follower">
                            </div>
                        </header>
                    </div>
                    <!-- DEBUT TWEET -->
                    <div id="tweets">
                        <?php
                        include("../controllers/tweetctrl.php");
                        ?>
                    </div>
                    <!-- FIN TWEET -->
                </div>
